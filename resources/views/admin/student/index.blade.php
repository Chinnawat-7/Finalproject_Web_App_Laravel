...
<x-slot name="header">
    ...
    <div class="py-12">
            <center>
                <a class="btn btn-info" href="" data-bs-toggle="modal" data-bs-target="#myModal">รายวิชาทั้งหมดที่ลงทะเบียน</a>
            </center><br>
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    @endif
                    <div class="card">
                        <div class="card-header">ตารางข้อมูลวิชา</div>
                    </div>
                    <div class="row">
                            <table class="table">
                            <thead>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('addStudent')}}" method="post">
                                ...
                                @enderror
                                <div class="form-groub">
                                    <label for="student_subject">ชื่อวิชา</label>
                                    <input type="text"class="form-control" name=student_subject >
                                </div>
                                @error('student_subject')
                                    <div>
                                    <span class="text-danger my-2">{{$message}}</span>
                                    </div>
                                @enderror
